        ...
        <Navbar className="bg-transparent text-white">
            ...
            <NavbarCollapse>
                <NavbarNav orientation="end">
                    <NavbarItem>
                        <NavbarLink className="hover:text-blue-400" href="#">Gallery</NavbarLink>
                    </NavbarItem>
                    <NavbarItem>
                        <NavbarLink className="hover:text-blue-400" href="#">Roadmap</NavbarLink>
                    </NavbarItem>
                    <NavbarItem>
                        <NavbarLink className="hover:text-blue-400" href="#">Team</NavbarLink>
                    </NavbarItem>
                    <NavbarItem>
                        <NavbarLink className="hover:text-blue-400" href="#">FAQ</NavbarLink>
                    </NavbarItem>
                </NavbarNav>
            </NavbarCollapse>
        </Navbar>
